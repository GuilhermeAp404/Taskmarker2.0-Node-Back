...
router
    ...
    .post("/user/logout", authVerification, (req, res, next)=>userControllers.registerUser(req, res, next))
    .post("/user/create", (req, res, next)=>userControllers.registerUser(req, res, next))
